...
namespace MissionMattersRound2.Controllers
{
    public class MissionsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "missionID,missionName,missionPresidentName,missionAddress,language,climate,dominantReligion,flagSymbol")] Mission mission)
        {
            if (ModelState.IsValid)
            {
