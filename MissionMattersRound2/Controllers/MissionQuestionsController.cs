...
namespace MissionMattersRound2.Controllers
{
    public class MissionQuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "missionQuestionID,userID,question,answer,missionID")] MissionQuestion missionQuestion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "missionQuestionID,userID,question,answer,missionID")] MissionQuestion missionQuestion)
        {
            if (ModelState.IsValid)
            {
